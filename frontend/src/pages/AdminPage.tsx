      ...
      <div className="space-y-6">
        ...
        {isSuperAdmin && activeTab === 'hospitals' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Left Side: Create/Edit Hospital Form */}
            ...
            {/* Right Side: Registered Facilities Directory List */}
            <div className="lg:col-span-1">
              <div className="glass-panel border border-brand-border/40 rounded-2xl p-6">
                ...
                <div className="divide-y divide-brand-border/20 text-xs space-y-2 max-h-[500px] overflow-y-auto pr-1">
                  {facilities?.map(fac => (
                    <div key={fac.id} className="py-3 flex flex-col justify-between items-start first:pt-0 last:pb-0 gap-2">
                      <div>
                      ...
                      <div className="flex items-center justify-between w-full mt-1.5 pt-1.5 border-t border-brand-border/5">
        ...
        {activeTab === 'workers' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Right Side: Staff Directory List */}
            <div className="lg:col-span-1">
